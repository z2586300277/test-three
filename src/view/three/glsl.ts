...
export function batchIdHighlightShaderMixin(material: any) {

    const newShader = { ...ShaderLib.standard, transparent: true, opacity: 0.1 };
    newShader.uniforms = {
...
void main() {
    ...
    return new ShaderMaterial(newShader)
