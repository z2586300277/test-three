...
function init(DOM:any) {
    ...
    DOM.addEventListener('click',(e:any) => uniforms.Mouse.value = getWebGLMouse(e))
    ...
    window.onresize = () => uniforms.Resolution.value = new THREE.Vector2(DOM.clientWidth, DOM.clientHeight)
    render()
    function render() {
