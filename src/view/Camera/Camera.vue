...
function init(DOM:any) {
    ...
    const camera2 = new THREE.PerspectiveCamera(50,DOM.clientWidth / DOM.clientHeight, 0.1, 100000)
    ...
    render()
    function render() {
        renderer.setViewport(0, 0, DOM.clientWidth / 2, DOM.clientHeight);
        renderer.setScissor(0, 0, DOM.clientWidth / 2, DOM.clientHeight);
        renderer.render(scene, camera);
        renderer.setViewport(DOM.clientWidth / 2, 0, DOM.clientWidth / 2, DOM.clientHeight);
        renderer.setScissor(DOM.clientWidth / 2, 0, DOM.clientWidth / 2, DOM.clientHeight);
        renderer.render(scene, camera);
